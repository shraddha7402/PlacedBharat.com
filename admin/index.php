...
<body class="hold-transition login-page bg-gray-800 text-white">
  ...
  <div class="login-box " id="sms">
    ...
    <div class="login-logo text-white">
      <a style="color:white" href="../index.php">PlaceBharat</a>
    </div>
    <!-- /.login-logo -->
    ...
    <footer id="footer" class="text-gray-600 body-font bg-gray-800 border-t-2 border-gray-700 small mb-0 ">
      ...
      <div class="pt-1 pb-2">
        <ul class="flex  space-x-16 justify-center text-white my-4 ">
          ...
          <strong>Copyright &copy; 2023 <a href="learningfromscratch.online">PlaceBharat</a>.</strong> All rights
        reserved.
          <li><i class="fa  fa-github" onclick="location.href='https://github.com/shraddha7402'" aria-hidden="true"></i></li>
          <li><i class="fa fa-instagram" onclick="location.href='https://www.instagram.com/_shraddha_7402/'" aria-hidden="true"></i></li>
          <li><i class="fa fa-linkedin" onclick="location.href='https://www.linkedin.com/in/shraddha-hajari-623b14219/' aria-hidden="true"></i></li>
